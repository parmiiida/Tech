    ...
    <section className="h-screen w-full bg-black flex items-center">
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-12 px-6 md:px-12 py-10">
        ...
        <div className="relative w-full md:w-[50%]">
          ...
          />
          <h1 className="text-white border-2 border-white text-4xl md:text-6xl font-bold px-6 py-6 uppercase absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center">
            Who we are
          </h1>
        </div>
